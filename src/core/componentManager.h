    ...
    public:
        ...
        std::vector<IntersectionComponents<Head, Tail...>> intersection() {
            ...
            for (auto& headComponent : headComponents) {
                ...
                if (fillWithRequiredComponents<IntersectionComponents<Head, Tail...>, Tail...>(headComponent.entityID,
                                                                                               currentEntityRequiredComponents)) {
        ...
        bool validComponentPointer(T* componentPtr, EntityID entityID) {
            ...
            return &comps.front() <= componentPtr && componentPtr <= &comps.back() &&
